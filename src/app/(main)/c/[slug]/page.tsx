...
const CATEGORY_CONTENT: Record<string, CatContent> = {
  'den-trung-thu': {
    intro: [
      'Lồng đèn Trung Thu là linh hồn của Tết Thiếu Nhi Việt Nam — mỗi năm đến rằm tháng 8, hàng triệu chiếc đèn trung thu thủ công thắp sáng đường phố, sân nhà và tâm hồn của những đứa trẻ. Tại KAHA, chúng tôi chuyên sản xuất và phân phối lồng đèn trung thu thủ công từ làng nghề Hội An, với hơn 200 mẫu đèn cho mùa Trung Thu 2025.',
      'Bộ sưu tập đèn trung thu của KAHA bao gồm đầy đủ các loại đèn truyền thống: đèn ông sao 5 cánh và 8 cánh, đèn cá chép, đèn con bướm, đèn kéo quân, đèn lồng tròn vải lụa, và đèn lồng tre đan thủ công. Tất cả được làm từ chất liệu an toàn cho trẻ em — khung tre tự nhiên, vải lụa không phai màu, dây điện đạt chuẩn an toàn.',
      ...
      'Giá đèn trung thu tại KAHA: đèn lẻ từ 35.000đ – 450.000đ/chiếc tùy loại. Đặt sỉ từ 50 chiếc giảm 15–25%, từ 200 chiếc có thể in logo thương hiệu. Phù hợp trường học, trung tâm thiếu nhi, siêu thị và doanh nghiệp tổ chức sự kiện Trung Thu. Xuất xứ: 100% Việt Nam — sản xuất tại Hội An, Quảng Nam.',
      'Đơn sỉ từ 100 chiếc trở lên nên đặt trước lễ ít nhất 3–4 tuần để đảm bảo giao hàng đúng hẹn. KAHA giao hàng toàn quốc qua GHN và GHTK, đóng gói chắc chắn đảm bảo đèn không biến dạng trong vận chuyển.',
    ],
    relatedPosts: [
    ...
    faq: [
      { q: 'Đèn trung thu thủ công KAHA được làm từ chất liệu gì?', a: 'Đèn trung thu KAHA sử dụng khung tre già tự nhiên, vải lụa hoặc organza cao cấp không phai màu, và giấy bồi nhiều lớp. Tất cả chất liệu an toàn cho trẻ em, không chứa hóa chất độc hại. Dây điện đi kèm đạt chuẩn an toàn điện Việt Nam.' },
      { q: 'Giá đèn trung thu sỉ tại KAHA là bao nhiêu?', a: 'Giá đèn trung thu sỉ: từ 50 chiếc giảm 15%, từ 100 chiếc giảm 20%, từ 200 chiếc giảm 25% so với giá lẻ. Giá lẻ từ 35.000đ – 450.000đ/chiếc tùy mẫu. Liên hệ 0989.778.247 để nhận báo giá sỉ chi tiết.' },
      { q: 'Có thể in logo lên đèn trung thu không?', a: 'Có, KAHA nhận in logo hoặc chữ thêu lên đèn trung thu với số lượng từ 200 chiếc trở lên. Có thể in trực tiếp hoặc thêu tay tùy yêu cầu. Thời gian sản xuất thêm 5–7 ngày so với đèn thông thường.' },
      ...
      { q: 'Đèn trung thu có an toàn cho trẻ em không?', a: 'Có. Đèn trung thu KAHA được sản xuất với tiêu chí an toàn cho trẻ em: chất liệu không độc hại, cạnh tre được vát nhẵn, dây điện có lớp cách điện đạt chuẩn. Đèn dùng bóng LED tiết kiệm điện, ít phát nhiệt, giảm nguy cơ cháy vải.' },
      { q: 'Có những loại đèn trung thu nào tại KAHA?', a: 'KAHA có hơn 200 mẫu đèn trung thu: đèn ông sao (5 cánh, 8 cánh), đèn cá chép, đèn con bướm, đèn kéo quân, đèn lồng tròn vải lụa nhiều cỡ, đèn lồng tre đan, đèn ngôi sao nhựa nhiều màu, và đèn lồng giấy xếp nghệ thuật. Cập nhật mẫu mới 2025.' },
      { q: 'Mua đèn trung thu số lượng ít có được không?', a: 'Hoàn toàn có thể. KAHA bán lẻ từ 1 chiếc, không yêu cầu số lượng tối thiểu cho đơn lẻ. Đặt hàng online qua website hoặc liên hệ 0989.778.247 (8:00–21:00 mỗi ngày).' },
      { q: 'Đèn trung thu KAHA có xuất xứ ở đâu?', a: 'Toàn bộ đèn trung thu tại KAHA được sản xuất tại Việt Nam — chủ yếu tại làng nghề Hội An (Quảng Nam) và xưởng TP.HCM. Không nhập hàng từ nước ngoài. 100% thủ công Việt Nam.' },
    ],
  },

  'hoi-an-lantern': {
    intro: [
      'Đèn lồng Hội An chính gốc — được làm thủ công tại xưởng liên kết trực tiếp với làng nghề phố cổ Hội An, Quảng Nam. Mỗi chiếc đèn lồng Hội An tại KAHA là sản phẩm của đôi tay nghệ nhân lành nghề, sử dụng đúng kỹ thuật truyền thống đã được UNESCO công nhận là di sản văn hóa phi vật thể.',
      'Bộ sưu tập hơn 500 mẫu đèn lồng Hội An tại KAHA đa dạng về hình dạng, màu sắc và chất liệu: từ đèn lồng tròn vải lụa truyền thống (ø20cm – ø60cm), đèn lồng oval, đèn lồng hình thuyền, đến đèn lồng khắc gỗ và đèn lồng vẽ tay nghệ thuật. Màu sắc phong phú từ đỏ, vàng, xanh lam, cam đến pastel nhẹ nhàng.',
      'Đèn lồng Hội An KAHA phù hợp cho mọi không gian: nhà ở, quán cafe phong cách vintage, nhà hàng ẩm thực Việt, khách sạn boutique, và làm quà tặng quý khách nước ngoài. Giá từ 45.000đ – 380.000đ/chiếc. Nhận đặt sỉ từ 20 chiếc với giá ưu đãi, tùy chỉnh màu sắc theo yêu cầu.',
    ],
    relatedPosts: [
    ...
    faq: [
      ...
      { q: 'Đèn lồng Hội An KAHA có được làm tại Hội An không?', a: 'Có. KAHA liên kết trực tiếp với xưởng sản xuất tại phố cổ Hội An và làng nghề Cẩm Phô (Quảng Nam). Một phần sản phẩm được hoàn thiện tại xưởng TP.HCM nhưng khung và vải đều từ nghệ nhân Hội An.' },
      { q: 'Giá đèn lồng Hội An bao nhiêu một chiếc?', a: 'Giá đèn lồng Hội An tại KAHA từ 45.000đ (đèn mini ø15cm) đến 380.000đ (đèn đại ø60cm, khung gỗ). Phổ biến nhất là đèn ø30cm giá 85.000–150.000đ/chiếc. Đặt sỉ từ 20 chiếc giảm 10–20% tùy số lượng.' },
      { q: 'Có thể đặt màu sắc theo yêu cầu không?', a: 'Có, KAHA nhận đặt màu theo yêu cầu cho đơn từ 20 chiếc trở lên. Có thể chọn màu vải, màu tua rua, màu khung và hoa văn thêu. Thời gian sản xuất thêm 3–5 ngày so với mẫu có sẵn.' },
      { q: 'Đèn lồng Hội An có thể dùng ngoài trời không?', a: 'Đèn lồng vải truyền thống chỉ phù hợp không gian có mái che hoặc trong nhà. Nếu cần treo ngoài trời, nên chọn mẫu đèn tre hoặc đèn mây có xử lý chống ẩm. KAHA có dòng đèn outdoor riêng phù hợp ban công và sân vườn có mái.' },
    ],
  },
  ...
  'den-long-tet': {
    intro: [
      ...
      'Bộ sưu tập đèn lồng Tết tại KAHA gồm: đèn lồng tròn đỏ truyền thống (nhiều cỡ từ ø15cm đến ø80cm), đèn lồng hình thỏi vàng, đèn lồng chữ Phúc–Lộc–Thọ–Vạn, đèn lồng con giáp theo năm, và bộ đèn lồng dây trang trí mái hiên. Tất cả được làm thủ công từ vải lụa cao cấp, khung tre bền chắc, chỉ thêu tay tỉ mỉ.',
      'Giá đèn lồng Tết tại KAHA: lẻ từ 25.000đ – 350.000đ/chiếc. Đặt sỉ từ 50 chiếc giảm 20–30%. Đơn sỉ từ 100 chiếc nên đặt trước Tết ít nhất 4 tuần để đảm bảo giao hàng đúng dịp. KAHA giao toàn quốc, có phục vụ trang trí đèn lồng Tết tận nơi tại TP.HCM.',
    ],
    relatedPosts: [
    ...
    faq: [
      ...
      { q: 'Giá đèn lồng Tết sỉ tại KAHA?', a: 'Giá sỉ đèn lồng Tết: từ 50 chiếc giảm 20%, từ 100 chiếc giảm 25%, từ 200 chiếc giảm 30% so với giá lẻ. Ngoài ra còn có combo bộ đèn trang trí sảnh, mái hiên giá ưu đãi theo gói. Liên hệ 0989.778.247 để nhận báo giá.' },
      ...
      { q: 'Có dịch vụ trang trí đèn lồng Tết tận nơi không?', a: 'Có, KAHA cung cấp dịch vụ trang trí đèn lồng Tết tận nơi tại TP.HCM cho văn phòng, nhà hàng, khách sạn và trung tâm thương mại. Bao gồm tư vấn thiết kế, cung cấp đèn và lắp đặt. Liên hệ để được báo giá.' },
      { q: 'Đèn lồng Tết có thể treo ngoài trời không?', a: 'Đèn lồng vải truyền thống nên treo trong nhà hoặc hiên có mái che. Cho ban công và sảnh ngoài trời, KAHA có dòng đèn lồng Tết chất liệu tre hoặc đèn nhựa chịu nước, giữ màu đỏ bền đẹp dù nắng mưa.' },
    ],
  },
  ...
  'den-may-tre': {
    intro: [
      ...
      'Đèn mây tre của KAHA phù hợp phong cách rustic, wabi-sabi và nội thất Việt truyền thống. Chất liệu 100% tự nhiên: tre, mây, bẹ chuối. Màu sắc tự nhiên của gỗ tre, không sơn hóa chất — thân thiện môi trường và an toàn cho không gian sống. Kích thước đa dạng từ mini (ø10cm) đến đại (ø60cm).',
      'Giá đèn mây tre tại KAHA: từ 55.000đ – 420.000đ/chiếc tùy loại và kích thước. Đặt sỉ từ 30 chiếc giảm 15–20%. Xuất xứ: làng nghề Bình Dương, Quảng Nam và Bình Định. KAHA nhận gia công theo bản vẽ và tùy chỉnh kích thước cho dự án nội thất và khách sạn.',
    ],
    relatedPosts: [
    ...
    faq: [
      ...
      { q: 'Giá đèn mây tre sỉ tại KAHA?', a: 'Giá sỉ đèn mây tre: từ 30 chiếc giảm 15%, từ 100 chiếc giảm 20%, từ 500 chiếc giảm 25% so với giá lẻ. Giá lẻ từ 55.000đ – 420.000đ/chiếc. Có hỗ trợ mẫu thử trước khi đặt sỉ. Liên hệ 0989.778.247 để được tư vấn.' },
      { q: 'Đèn mây tre có dùng được ngoài trời không?', a: 'Đèn mây tre có thể treo ở ban công hoặc hiên có mái che (không tiếp xúc mưa trực tiếp). Không nên treo ngoài trời hoàn toàn vì ẩm ướt kéo dài sẽ làm mục tre. KAHA có xử lý chống ẩm theo yêu cầu cho đèn dùng outdoor có mái.' },
      { q: 'Có thể đặt kích thước tùy chỉnh không?', a: 'Có, KAHA nhận đặt đèn mây tre theo kích thước tùy chỉnh với số lượng từ 20 chiếc trở lên. Có thể tùy chỉnh: đường kính, chiều cao, hoa văn đan và màu sơn phủ bề mặt. Thời gian sản xuất 10–15 ngày.' },
      { q: 'Đèn mây tre KAHA được làm từ chất liệu gì?', a: 'Đèn mây tre KAHA sử dụng: tre già (3–5 năm tuổi) từ rừng tự nhiên, mây tự nhiên, bẹ chuối khô và lá cọ. Tất cả được phơi khô tự nhiên, không dùng hóa chất bảo quản độc hại. 100% vật liệu xuất xứ Việt Nam.' },
    ],
  },
  ...
  'den-kieu-nhat': {
    intro: [
      ...
      'Điểm khác biệt chính giữa đèn kiểu Nhật và đèn lồng Hội An: đèn Nhật sử dụng màu trung tính (trắng, be, nâu tự nhiên) và hình dạng trụ hoặc hộp vuông góc cạnh; trong khi đèn lồng Hội An thường có màu sắc rực rỡ và hình oval/tròn truyền thống. Cả hai đều được làm thủ công tại xưởng KAHA.',
      'Đèn kiểu Nhật phù hợp cho: quán trà, onsen spa, nhà hàng Nhật, phòng thiền định, góc đọc sách yên tĩnh. Giá từ 65.000đ – 580.000đ/chiếc. Hơn 80 mẫu hiện có, nhận đặt riêng theo yêu cầu. KAHA là một trong số ít xưởng tại Việt Nam sản xuất đèn kiểu Nhật chính thống.',
    ],
    relatedPosts: [
    ...
    faq: [
      { q: 'Đèn kiểu Nhật KAHA có phải hàng nhập từ Nhật không?', a: 'Không. Đèn kiểu Nhật tại KAHA được sản xuất hoàn toàn tại Việt Nam bởi nghệ nhân Việt, lấy cảm hứng từ thiết kế chochin và andon truyền thống Nhật Bản. Chất liệu 100% trong nước: tre Việt, giấy dó Việt, vải mỏng nội địa. Giá thành rẻ hơn hàng nhập 3–5 lần.' },
      ...
      { q: 'Giá đèn kiểu Nhật bao nhiêu?', a: 'Giá đèn kiểu Nhật tại KAHA từ 65.000đ (đèn mini ø15cm) đến 580.000đ (đèn đại, hộp gỗ). Phổ biến nhất là đèn trụ ø20cm giá 120.000–180.000đ/chiếc. Đặt sỉ từ 20 chiếc giảm 15–20%.' },
  ...
  'den-vai-cao-cap': {
    intro: [
      'Đèn vải cao cấp — dòng sản phẩm đỉnh cao trong bộ sưu tập KAHA, kết hợp giữa chất liệu lụa tự nhiên, organza và cotton thủ công với kỹ thuật may vá truyền thống. Mỗi chiếc đèn vải được cắt may tỉ mỉ, căng đều trên khung thép sơn tĩnh điện bền đẹp, tạo ra ánh sáng ấm áp, dịu nhẹ đặc trưng không loại đèn nào có được.',
      'Bộ sưu tập đèn vải cao cấp tại KAHA có hơn 150 mẫu với đầy đủ hình dạng: tròn, oval, trụ, hộp vuông và hình đèn lồng truyền thống. Màu sắc phong phú gồm hơn 12 tông màu tiêu chuẩn (trắng, vàng champagne, nâu camel, đỏ đô, xanh ngọc, hồng nude, tím lavender...) — tất cả đều có thể đặt riêng theo màu Pantone. Kích thước từ ø20cm đến ø80cm, chiều cao tùy chỉnh.',
      'Đèn vải cao cấp KAHA phù hợp cho: khách sạn boutique 4–5 sao, nhà hàng fine dining, spa cao cấp, tiệc cưới sang trọng, showroom và biệt thự. Có thể in/thêu logo thương hiệu lên vải từ 50 chiếc trở lên. Giá từ 120.000đ – 680.000đ/chiếc tùy chất liệu và kích thước. Đặt sỉ từ 20 chiếc giảm 15–25%.',
      'Chất liệu vải đèn tại KAHA gồm 3 dòng: vải lụa tự nhiên (cao cấp nhất, bề mặt mịn bóng, xuyên sáng đều), vải organza (mỏng nhẹ, xuyên sáng tốt, màu sắc tươi sáng) và vải cotton dày 280gsm (bền, ít nhăn, phù hợp không gian thương mại). Khung thép chịu tải tốt, không gỉ, có thể dùng bóng LED E27 hoặc GU10 tùy model.',
    ],
    relatedPosts: [
    ...
    faq: [
      { q: 'Đèn vải cao cấp KAHA dùng chất liệu gì?', a: 'KAHA có 3 dòng vải chính: lụa tự nhiên (mịn bóng, cao cấp nhất), organza (mỏng nhẹ, xuyên sáng tốt) và cotton 280gsm (bền, ít nhăn). Khung thép sơn tĩnh điện chống gỉ. Tất cả chất liệu đạt tiêu chuẩn PCCC, an toàn cho không gian thương mại và dân dụng.' },
      { q: 'Giá đèn vải cao cấp sỉ tại KAHA bao nhiêu?', a: 'Giá lẻ từ 120.000đ – 680.000đ/chiếc tùy loại và kích thước. Đặt sỉ từ 20 chiếc giảm 15%, từ 50 chiếc giảm 20%, từ 100 chiếc giảm 25%. Mẫu đặt riêng theo màu Pantone cần tối thiểu 30 chiếc. Liên hệ 0989.778.247 để nhận báo giá chi tiết.' },
      { q: 'Có thể đặt màu vải theo yêu cầu không?', a: 'Có. KAHA nhận đặt màu vải theo mã Pantone hoặc mẫu vải khách hàng cung cấp, tối thiểu 30 chiếc/màu. Có thể phối nhiều màu trong cùng đơn hàng. Thời gian sản xuất thêm 3–5 ngày so với mẫu màu tiêu chuẩn.' },
      { q: 'Đèn vải có thể dùng ngoài trời không?', a: 'Đèn vải lụa và organza chỉ phù hợp trong nhà hoặc hiên có mái che hoàn toàn. Dòng cotton 280gsm có thể dùng nơi thoáng mát nhưng tránh mưa trực tiếp. KAHA có dòng đèn vải xử lý chống ẩm và phủ nano cho outdoor theo đặt hàng riêng.' },
      ...
      { q: 'Bóng đèn nào phù hợp với đèn vải KAHA?', a: 'Khuyến nghị dùng bóng LED E27 3W–5W nhiệt độ màu 2700K–3000K (vàng ấm) để tạo ánh sáng đẹp nhất qua vải. Không dùng bóng sợi đốt vì phát nhiệt cao dễ hỏng vải. KAHA có bán kèm bóng LED phù hợp theo yêu cầu.' },
    ],
  },
  ...
  'den-tha-tran': {
    intro: [
      ...
      'KAHA cung cấp đèn thả trần với đầy đủ chủng loại: đèn lồng vải thả đơn, chùm đèn lồng Hội An 3–5–7 chiếc/chùm, đèn mây tre thả nghệ thuật và đèn vải cao cấp thả phòng ăn. Dây thả có thể điều chỉnh độ dài từ 50cm đến 3m theo trần nhà. Phù hợp trần cao từ 2.5m trở lên.',
      'Dịch vụ lắp đặt đèn thả trần trọn gói tại TP.HCM: KAHA đo đạc thực địa miễn phí, tư vấn phối màu và bố cục, cung cấp đèn và lắp đặt đến khi hoàn chỉnh. Nhận dự án từ 10 đèn trở lên. Đã lắp đặt cho hơn 80 nhà hàng, quán cafe và khách sạn tại TP.HCM và các tỉnh.',
      'Giá đèn thả trần tại KAHA: đèn đơn từ 85.000đ – 480.000đ/chiếc tùy loại. Combo chùm 5 chiếc từ 350.000đ – 1.500.000đ/chùm. Phí lắp đặt tính riêng theo diện tích và độ phức tạp. Liên hệ 0989.778.247 để được tư vấn thiết kế và báo giá thi công.',
    ],
    relatedPosts: [
    ...
    faq: [
      { q: 'Đèn thả trần nên treo ở độ cao bao nhiêu?', a: 'Đèn thả bàn ăn: đáy đèn cách mặt bàn 60–75cm. Đèn thả hành lang/lối đi: đáy đèn cách sàn ít nhất 210cm. Đèn trang trí không gian rộng (nhà hàng, tiệc): bố cục nhiều tầng cao, tạo chiều sâu. KAHA tư vấn bố cục miễn phí khi đặt đơn từ 10 chiếc.' },
      ...
      { q: 'KAHA có dịch vụ lắp đặt đèn thả trần không?', a: 'Có, KAHA cung cấp dịch vụ lắp đặt trọn gói tại TP.HCM: đo đạc thực địa, tư vấn bố cục, cung cấp đèn và lắp đặt. Nhận từ 10 đèn trở lên. Phí lắp đặt tính theo số lượng đèn và độ cao trần. Liên hệ để được khảo sát miễn phí.' },
      { q: 'Đèn thả trần phù hợp với loại trần nào?', a: 'Đèn thả trần phù hợp với trần bê tông, trần thạch cao và trần gỗ có độ cao từ 2.5m trở lên. Với trần thấp hơn 2.5m nên chọn đèn áp trần hoặc đèn thả mini. KAHA cung cấp móc trần và phụ kiện treo phù hợp từng loại trần.' },
      { q: 'Dây treo đèn có thể điều chỉnh độ dài không?', a: 'Có. Tất cả đèn thả trần KAHA đều có dây điện bọc vải có thể điều chỉnh độ dài từ 50cm đến 3m. Khi đặt hàng cần thông báo chiều cao trần và vị trí treo để KAHA cắt dây đúng độ dài, tiết kiệm thời gian lắp đặt.' },
    ],
  },
  ...
  'den-quan-cafe': {
    intro: [
      ...
      'KAHA đã cung cấp đèn trang trí cho hơn 200 quán cafe tại TP.HCM và toàn quốc, từ quán nhỏ 30m² đến chuỗi cafe 10+ chi nhánh. Các phong cách phổ biến nhất: vintage Hội An (đèn lồng vải nhiều màu), Nhật Bản wabi-sabi (đèn kiểu Nhật tông trắng/nâu), boho tự nhiên (đèn mây tre) và Indochine thanh lịch (đèn thả vải cao cấp).',
      'Gói trang trí đèn quán cafe trọn gói: KAHA tư vấn phối màu theo concept quán, lựa chọn model đèn phù hợp, tính toán số lượng và bố cục tối ưu, giao hàng tận nơi và hỗ trợ lắp đặt tại TP.HCM. Đã phục vụ: The Coffee House, Phúc Long (một số chi nhánh), nhiều quán cafe độc lập nổi tiếng tại Q.1, Q.3, Bình Thạnh, Thủ Đức.',
      'Giá đèn trang trí quán cafe tại KAHA: từ 45.000đ – 480.000đ/chiếc tùy loại. Gói trang trí trọn bộ 20 đèn cho quán nhỏ từ 2.500.000đ – 6.000.000đ tùy model. Đặt sỉ từ 20 chiếc giảm 15–25%. Bảo hành đèn 12 tháng, hỗ trợ thay thế nhanh trong vòng 48 giờ tại TP.HCM.',
    ],
    relatedPosts: [
    ...
    faq: [
      { q: 'Nên chọn loại đèn nào cho quán cafe phong cách vintage?', a: 'Phong cách vintage Hội An: đèn lồng vải nhiều màu (đỏ, vàng, cam, tím) kết hợp đèn thả trần. Phong cách Nhật Bản: đèn kiểu Nhật tông trắng/be treo đơn hoặc cụm 3 chiếc. Phong cách rustic boho: đèn mây tre nhiều cỡ, kết hợp cây xanh. KAHA tư vấn miễn phí theo ảnh concept quán.' },
      { q: 'Quán cafe cần bao nhiêu đèn lồng để đủ đẹp?', a: 'Quán 30–50m²: tối thiểu 15–25 đèn, bố cục thả trần + góc accent. Quán 50–100m²: 30–50 đèn. Quán trên 100m² hoặc nhiều tầng: 50+ đèn. KAHA tư vấn số lượng cụ thể dựa trên ảnh mặt bằng, không tính phí.' },
      { q: 'Đèn trang trí quán cafe có bền không, mất bao lâu thì phải thay?', a: 'Đèn vải bền 2–4 năm trong điều kiện trong nhà có máy lạnh. Đèn mây tre bền 3–6 năm. Đèn lồng Hội An truyền thống bền 1–3 năm tùy bảo quản. KAHA bảo hành 12 tháng và hỗ trợ thay thế nhanh tại TP.HCM để quán không bị gián đoạn kinh doanh.' },
      ...
      { q: 'KAHA có tư vấn thiết kế đèn cho quán cafe không?', a: 'Có, KAHA cung cấp dịch vụ tư vấn trang trí đèn miễn phí cho đơn từ 20 chiếc trở lên: chọn model, phối màu, bố cục, tính số lượng. Khách hàng chỉ cần gửi ảnh mặt bằng và concept tham khảo qua Zalo 0989.778.247.' },
    ],
  },

  'den-khach-san': {
    intro: [
      'Đèn trang trí resort & khách sạn — phân khúc đòi hỏi tiêu chuẩn cao nhất về chất liệu, tính thẩm mỹ và độ bền. KAHA chuyên cung cấp đèn lồng thủ công cho các dự án khách sạn 3–5 sao, resort nghỉ dưỡng và boutique hotel trên toàn quốc, với kinh nghiệm thực hiện hơn 50 dự án hospitality trong 5 năm qua.',
      'Điểm mạnh của đèn KAHA trong dự án khách sạn: (1) Tùy chỉnh hoàn toàn theo bộ nhận diện thương hiệu — màu sắc, hoa văn, kích thước và in logo; (2) Số lượng lớn đồng nhất — mỗi chiếc đèn trong cùng đơn hàng được kiểm soát chất lượng nghiêm ngặt để đảm bảo đồng đều; (3) Dịch vụ lắp đặt và bảo trì định kỳ tại TP.HCM và một số tỉnh thành.',
      'KAHA đã cung cấp đèn cho: các resort tại Phú Quốc, Đà Nẵng, Hội An, Mũi Né và Nha Trang. Hạng mục thực hiện: đèn thả sảnh chính, đèn hành lang, đèn trang trí nhà hàng trong resort, đèn bể bơi và khu vực outdoor có mái che, đèn spa và khu dịch vụ cao cấp.',
      'Quy trình dự án khách sạn: tư vấn và khảo sát thực địa → thiết kế bản vẽ kỹ thuật → mẫu thử duyệt → sản xuất đại trà → kiểm tra chất lượng 100% → vận chuyển và lắp đặt → nghiệm thu. Thời gian triển khai dự án 200 đèn trở lên: 4–6 tuần. Liên hệ hi@kaha.vn cho dự án B2B.',
    ],
    relatedPosts: [
    ...
    faq: [
      { q: 'KAHA có kinh nghiệm cung cấp đèn cho dự án khách sạn lớn không?', a: 'Có. KAHA đã thực hiện hơn 50 dự án khách sạn và resort từ 3 đến 5 sao trên toàn quốc, bao gồm các resort tại Phú Quốc, Đà Nẵng, Hội An và Nha Trang. Đơn hàng lớn nhất thực hiện là 1.200 chiếc đèn cho một resort 5 sao tại Đà Nẵng.' },
      { q: 'Đèn cho khách sạn có thể tùy chỉnh theo thương hiệu không?', a: 'Có hoàn toàn. KAHA nhận tùy chỉnh: màu vải theo mã Pantone hoặc màu thương hiệu, in/thêu logo lên đèn, kích thước và hình dạng riêng, và cả hoa văn độc quyền. Số lượng tối thiểu cho đặt hàng tùy chỉnh hoàn toàn là 100 chiếc.' },
      ...
      { q: 'Có dịch vụ lắp đặt và bảo trì đèn cho khách sạn không?', a: 'Có, KAHA cung cấp dịch vụ lắp đặt tận nơi tại TP.HCM và các tỉnh theo thỏa thuận. Bảo trì định kỳ theo hợp đồng: kiểm tra, vệ sinh và thay thế đèn hỏng. Hỗ trợ khẩn cấp trong 48 giờ cho khách sạn tại TP.HCM.' },
      { q: 'Giá đèn cho dự án khách sạn tính như thế nào?', a: 'Giá dự án khách sạn được tính theo số lượng, mức độ tùy chỉnh và chất liệu. Thường giảm 25–35% so với giá lẻ cho đơn từ 200 chiếc trở lên. Liên hệ hi@kaha.vn hoặc 0989.778.247 để nhận báo giá dự án trong 24 giờ làm việc.' },
    ],
  },

  'den-nha-hang': {
    intro: [
      'Đèn trang trí nhà hàng — yếu tố then chốt tạo nên trải nghiệm ẩm thực đáng nhớ. Ánh sáng đúng tông màu và bầu không khí đèn lồng thủ công không chỉ nâng tầm món ăn về mặt thị giác mà còn tạo cảm xúc gắn kết khách hàng với thương hiệu nhà hàng. KAHA đã cung cấp đèn cho hơn 120 nhà hàng trên toàn quốc.',
      'Phong cách đèn phổ biến nhất trong nhà hàng hiện nay: (1) Đèn lồng Hội An nhiều màu cho nhà hàng ẩm thực Việt truyền thống; (2) Đèn mây tre tự nhiên cho nhà hàng organic và farm-to-table; (3) Đèn vải cao cấp tone trung tính cho nhà hàng fine dining; (4) Đèn kiểu Nhật cho nhà hàng sushi, BBQ Nhật và izakaya. KAHA tư vấn phong cách phù hợp từng loại hình nhà hàng.',
      'Giải pháp đèn nhà hàng trọn gói từ KAHA: khảo sát mặt bằng và phân tích ánh sáng miễn phí, thiết kế phương án bố cục đèn theo từng khu vực (khu ăn chính, quầy bar, lối vào, WC), cung cấp đèn và lắp đặt tại TP.HCM. Bảo hành 12 tháng, thay thế nhanh đảm bảo nhà hàng không gián đoạn hoạt động.',
    ],
    relatedPosts: [
    ...
    faq: [
      { q: 'Nhà hàng nên chọn loại đèn lồng nào?', a: 'Phụ thuộc vào concept: nhà hàng Việt truyền thống → đèn lồng Hội An nhiều màu; nhà hàng Nhật → đèn kiểu Nhật tông trắng/nâu; nhà hàng hải sản/quán nhậu → đèn mây tre rustic; fine dining → đèn vải cao cấp tông trung tính. KAHA tư vấn miễn phí dựa trên ảnh concept nhà hàng.' },
      { q: 'Đặt bao nhiêu đèn cho nhà hàng 100 chỗ ngồi?', a: 'Nhà hàng 100 chỗ ngồi (~150–200m²) thường cần 40–80 đèn tùy bố cục và kích thước đèn. Khu ăn chính: 1 đèn/4–6m² trần. Lối vào và khu chờ: accent 5–10 đèn. Quầy bar: 3–8 đèn thả. KAHA tính số lượng cụ thể theo bản vẽ mặt bằng miễn phí.' },
      { q: 'Đèn nhà hàng có bao lâu thì phải thay?', a: 'Đèn vải: 2–3 năm (khuyến nghị vệ sinh 6 tháng/lần). Đèn mây tre: 3–5 năm. Đèn lồng Hội An: 1.5–2.5 năm. Độ bền phụ thuộc môi trường (độ ẩm, khói bếp, điều hòa). KAHA cung cấp gói bảo trì định kỳ cho nhà hàng theo hợp đồng, đảm bảo thay thế nhanh không ảnh hưởng kinh doanh.' },
      ...
      { q: 'KAHA có lắp đặt đèn nhà hàng tận nơi không?', a: 'Có, dịch vụ lắp đặt tại TP.HCM miễn phí cho đơn từ 30 chiếc trở lên. Các tỉnh thành khác: phí lắp đặt tính theo khoảng cách. Lắp đặt ngoài giờ (tối hoặc cuối tuần) để không ảnh hưởng giờ kinh doanh nhà hàng theo thỏa thuận.' },
    ],
  },

  'den-long-go': {
    intro: [
      'Đèn lồng gỗ chạm khắc — phân khúc cao cấp nhất trong dòng đèn thủ công Việt Nam, kết hợp kỹ thuật chạm khắc gỗ tinh xảo với ánh sáng xuyên qua những hoa văn tỉ mỉ. Mỗi chiếc đèn gỗ KAHA là tác phẩm nghệ thuật độc bản, được chạm tay bởi nghệ nhân có hơn 20 năm kinh nghiệm từ làng nghề Đồng Kỵ (Bắc Ninh) và Cẩm Hà (Hội An).',
    ...
    faq: [
      { q: 'Đèn lồng gỗ KAHA được làm từ loại gỗ nào?', a: 'KAHA dùng nhiều loại gỗ: pơmu (bền, thơm), hương đỏ (vân đẹp), trắc (cao cấp nhất), thông (nhẹ, giá tốt) và MDF phủ veneer (cho đơn số lượng lớn). Gỗ tự nhiên được xử lý chống ẩm và mối mọt. Tư vấn loại gỗ phù hợp ngân sách và mục đích sử dụng khi liên hệ đặt hàng.' },
      ...
      { q: 'Đèn gỗ có thể đặt làm quà tặng doanh nghiệp không?', a: 'Hoàn toàn có thể. KAHA nhận đặt đèn gỗ làm quà tặng từ 10 chiếc: khắc laser logo/tên công ty/thông điệp, đóng hộp gỗ sang trọng kèm thiệp. Giá quà tặng doanh nghiệp từ 350.000đ/bộ. Giao hàng toàn quốc, có hóa đơn VAT.' },
  ...
  'den-ve-tranh': {
    intro: [
      'Đèn vẽ tranh thủ công — phân khúc nghệ thuật độc đáo nhất của KAHA, nơi mỗi chiếc đèn lồng trở thành một tác phẩm hội họa thu nhỏ. Họa sĩ vẽ tay trực tiếp lên vải đèn bằng màu acrylic chuyên dụng, tạo ra những họa tiết không chiếc nào giống chiếc nào — đảm bảo tính độc bản tuyệt đối.',
      'Các chủ đề tranh phổ biến tại KAHA: phong cảnh làng quê Việt Nam (cánh đồng lúa, sông nước, đồi núi), hoa sen và hoa đào truyền thống, tranh Đông Hồ dân gian, phong cảnh phố cổ Hội An và Hà Nội, 12 con giáp nghệ thuật, và các họa tiết theo yêu cầu riêng của khách hàng. Màu vẽ bền màu, không lem khi treo trong môi trường bình thường.',
      'Đèn vẽ tranh KAHA phù hợp làm: quà tặng cao cấp cho đối tác nước ngoài, quà lưu niệm du lịch Việt Nam, trang trí gallery và không gian văn hóa, bộ sưu tập nghệ thuật cá nhân. Giá từ 150.000đ – 1.200.000đ/chiếc tùy kích thước và độ phức tạp của tranh. Đặt vẽ tranh theo chủ đề riêng từ 5 chiếc trở lên.',
    ],
    relatedPosts: [
    ...
    faq: [
      { q: 'Đèn vẽ tranh KAHA được vẽ bằng gì, có bền màu không?', a: 'Đèn vẽ tranh dùng màu acrylic chuyên dụng cho vải, bền màu và không lem dưới điều kiện bình thường. Màu giữ đẹp 3–5 năm nếu để trong nhà, tránh ánh nắng trực tiếp chiếu vào mặt vải. Không giặt bằng nước. Lau nhẹ bằng khăn khô khi cần.' },
      { q: 'Có thể đặt vẽ tranh theo chủ đề riêng không?', a: 'Có, KAHA nhận đặt vẽ tranh theo chủ đề riêng từ 5 chiếc trở lên: logo thương hiệu, hình ảnh sản phẩm, chân dung cách điệu, phong cảnh đặc biệt. Khách hàng cung cấp ảnh/sketch tham khảo, họa sĩ phác thảo và xác nhận trước khi vẽ chính thức. Thời gian sản xuất 7–14 ngày.' },
      ...
      { q: 'Đèn vẽ tranh có phải hàng độc bản không?', a: 'Với đèn vẽ tay thủ công hoàn toàn, mỗi chiếc là một tác phẩm độc bản — không có 2 chiếc hoàn toàn giống nhau dù cùng chủ đề. KAHA có thể in số thứ tự và chữ ký họa sĩ lên đèn để chứng nhận tính độc bản nếu khách hàng yêu cầu.' },
      { q: 'Đèn vẽ tranh phù hợp làm quà tặng đối tác nước ngoài không?', a: 'Rất phù hợp. Đèn vẽ tranh KAHA mang đậm bản sắc văn hóa Việt Nam, có giá trị nghệ thuật cao, dễ mang theo (nhẹ, có thể tháo khung gấp gọn). KAHA đóng hộp quà sang trọng, kèm card tiếng Anh giải thích nghệ thuật đèn lồng Việt Nam và certificate of authenticity.' },
    ],
  },

  'chup-den-vai': {
    intro: [
      'Chụp đèn vải (chao đèn) thay thế và gia công số lượng lớn — KAHA cung cấp chụp đèn vải đa dạng với hơn 10 màu tiêu chuẩn: nâu camel, vàng champagne, xám khói, đen, trắng ngà, cam đất, hồng nude, tím lavender, xanh lá rừng, xanh dương navy. Đường kính từ 20cm đến 60cm, vải dày 280gsm, khung thép sơn tĩnh điện bền đẹp.',
      'Chụp đèn vải KAHA phù hợp cho việc thay thế chao đèn cũ, nâng cấp đèn phòng ngủ khách sạn, hoặc trang trí quán cafe và nhà hàng với số lượng lớn đồng bộ. Có thể kết hợp với đế đèn sẵn có hoặc đặt cùng bộ đèn hoàn chỉnh. Kích thước chuẩn E27 tương thích với hầu hết các loại đế đèn phổ biến.',
      'Giá chụp đèn vải tại KAHA: từ 65.000đ – 280.000đ/chiếc tùy kích thước và màu sắc. Đặt sỉ từ 30 chiếc giảm 15–20%, từ 100 chiếc giảm 25%. Giao hàng toàn quốc qua GHN trong 2–4 ngày làm việc. Nhận đặt màu Pantone riêng từ 50 chiếc trở lên.',
    ],
    relatedPosts: [
      { label: 'Chụp đèn vải thay thế — hướng dẫn chọn đúng kích thước', href: '/blog/chup-den-vai-thay-the' },
    ...
    faq: [
      { q: 'Chụp đèn vải có nhiều kích thước nào?', a: 'KAHA cung cấp chụp đèn vải từ ø20cm đến ø60cm, với các kích thước phổ biến: 20cm, 25cm, 30cm, 35cm, 40cm, 45cm, 50cm và 60cm. Chiều cao tương ứng từ 15cm đến 45cm. Nếu cần kích thước khác, có thể đặt riêng từ 50 chiếc trở lên.' },
      { q: 'Chụp đèn vải KAHA tương thích với đui đèn nào?', a: 'Toàn bộ chụp đèn vải KAHA đều tương thích đui E27 tiêu chuẩn — loại đui đèn phổ biến nhất tại Việt Nam. Khuyến nghị dùng bóng LED E27 3–5W nhiệt độ màu 2700K–3000K để ánh sáng vàng ấm đẹp nhất qua vải.' },
  ...
  'phong-khach': {
    intro: [
      'Đèn trang trí phòng khách — không gian tiếp khách là bộ mặt của ngôi nhà, và ánh sáng chính là yếu tố tạo nên ấn tượng đầu tiên. Đèn lồng thủ công KAHA mang vẻ đẹp nghệ thuật Việt Nam vào phòng khách, tạo điểm nhấn độc đáo mà không loại đèn công nghiệp nào có thể thay thế được.',
      ...
      'Giá đèn trang trí phòng khách tại KAHA: từ 85.000đ – 580.000đ/chiếc tùy model. Tư vấn miễn phí lựa chọn đèn phù hợp phong cách nội thất qua Zalo 0989.778.247 — chỉ cần gửi ảnh phòng khách, nhận ngay gợi ý cụ thể về model, màu sắc và cách bố trí.',
    ],
    relatedPosts: [
    ...
    faq: [
      { q: 'Nên chọn đèn lồng loại nào cho phòng khách?', a: 'Phòng khách hiện đại: đèn mây tre tông tự nhiên hoặc đèn vải tông trung tính. Phòng khách Indochine/cổ điển: đèn lồng Hội An vải lụa màu sắc rực rỡ hoặc đèn gỗ chạm khắc. Phòng khách nhỏ: đèn thả trần mini giúp tạo chiều cao ảo. KAHA tư vấn miễn phí qua ảnh.' },
      ...
      { q: 'Giá đèn phòng khách tại KAHA bao nhiêu?', a: 'Đèn nhỏ accent (ø15–20cm): 65.000đ – 150.000đ. Đèn vừa (ø25–35cm): 120.000đ – 280.000đ. Đèn lớn thả trần (ø40–60cm): 250.000đ – 580.000đ. Combo trang trí phòng khách đầy đủ (1 đèn chính + 4 đèn nhỏ) từ 600.000đ – 1.800.000đ.' },
      { q: 'Có dịch vụ tư vấn trang trí đèn phòng khách không?', a: 'Có, KAHA tư vấn miễn phí qua Zalo 0989.778.247: gửi ảnh phòng khách + phong cách mong muốn, nhận gợi ý cụ thể về model đèn, số lượng, cách bố trí và ước tính ngân sách. Dịch vụ tư vấn thiết kế và lắp đặt tại nhà có tính phí tại TP.HCM.' },
    ],
  },

  'phong-ngu': {
    intro: [
      'Đèn trang trí phòng ngủ — ánh sáng trong phòng ngủ cần đạt được sự cân bằng: đủ sáng để sinh hoạt nhưng đủ dịu nhẹ để thư giãn và dễ ngủ. Đèn lồng vải lụa, đèn mây tre và đèn kiểu Nhật của KAHA tạo ra ánh sáng lan toả tự nhiên qua chất liệu, không chói mắt, tạo cảm giác ấm áp và bình yên.',
      ...
      'Giá đèn trang trí phòng ngủ tại KAHA: từ 55.000đ – 420.000đ/chiếc. Combo đèn phòng ngủ (1 đèn thả + 2 đèn ngủ nhỏ) từ 250.000đ – 800.000đ. Nhận tư vấn miễn phí qua Zalo 0989.778.247.',
    ],
    relatedPosts: [
    ...
    faq: [
      ...
      { q: 'Đèn thả đầu giường cần treo ở độ cao bao nhiêu?', a: 'Đèn thả đầu giường treo tối ưu khi đáy đèn ngang tầm vai khi ngồi trên giường, khoảng 60–75cm tính từ mặt đệm. Độ cao này vừa đủ sáng để đọc sách, vừa không chói mắt khi nằm. Dây điện KAHA điều chỉnh được từ 50cm đến 2m.' },
      { q: 'Đèn lồng trong phòng ngủ có an toàn không?', a: 'An toàn khi dùng bóng LED (ít phát nhiệt). KAHA khuyến nghị bóng LED E27 3W nhiệt độ màu 2700K — tiêu thụ điện thấp, gần như không phát nhiệt, an toàn với vải đèn. Không dùng bóng sợi đốt vì nhiệt cao có thể làm hỏng vải lụa.' },
      { q: 'Giá đèn ngủ thủ công tại KAHA bao nhiêu?', a: 'Đèn ngủ nhỏ ø15–20cm: 55.000đ – 120.000đ. Đèn thả đầu giường ø25–35cm: 130.000đ – 280.000đ. Đèn vải cao cấp phòng ngủ resort ø30–45cm: 200.000đ – 420.000đ. Sỉ từ 20 chiếc giảm 15%.' },
  ...
  'ngoai-troi': {
    intro: [
      ...
      'KAHA có dòng đèn outdoor chuyên dụng: đèn tre và mây được xử lý chống ẩm, đèn lồng vải phủ nano waterproof, và đèn nhựa chịu mưa nắng bền màu. Phù hợp cho ban công chung cư (đèn nhỏ treo lan can), sân vườn biệt thự (đèn cột hoặc đèn treo dây giữa các cây), mái hiên nhà hàng và lối đi resort.',
      'Giá đèn ngoài trời tại KAHA: từ 75.000đ – 450.000đ/chiếc. Dây đèn lồng trang trí ban công từ 180.000đ/dây 5 chiếc. Đặt sỉ từ 20 chiếc giảm 15%. Tư vấn lắp đặt miễn phí cho dự án resort và sân vườn tại TP.HCM qua hotline 0989.778.247.',
    ],
    relatedPosts: [
    ...
    faq: [
      { q: 'Đèn lồng nào phù hợp treo ngoài trời?', a: 'Cho ngoài trời, chọn: đèn lồng tre/mây đã xử lý chống ẩm, đèn lồng nhựa chịu thời tiết, hoặc đèn vải phủ nano waterproof của KAHA. Tránh đèn lồng vải lụa thông thường — dễ phai màu và mục vải khi tiếp xúc mưa trực tiếp.' },
      ...
      { q: 'Ban công nhỏ nên trang trí đèn kiểu gì?', a: 'Ban công nhỏ dưới 4m² nên dùng: dây đèn lồng mini treo dọc lan can (5–7 chiếc), 1–2 đèn lồng nhỏ ø15–20cm treo góc, hoặc đèn cắm đất mini. Tránh đèn quá to làm ban công thêm chật. KAHA có bộ kit trang trí ban công từ 250.000đ.' },
      ...
      { q: 'Đèn lồng outdoor tại KAHA giá bao nhiêu?', a: 'Đèn tre/mây outdoor: 75.000đ – 320.000đ/chiếc. Đèn lồng nhựa màu sắc: 35.000đ – 120.000đ/chiếc. Dây đèn lồng ban công (5 chiếc): từ 180.000đ. Đặt sỉ từ 20 chiếc giảm 15%, từ 100 chiếc giảm 25%. Liên hệ 0989.778.247.' },
    ],
  },
  ...
  'den-noi-that': {
    intro: [
      ...
      'KAHA cung cấp đèn nội thất cao cấp cho biệt thự và căn hộ với đầy đủ giải pháp: đèn thả trần nghệ thuật cho phòng khách lớn, đèn đứng sàn bên sofa tạo điểm nhấn, đèn áp tường hành lang, đèn bàn trang trí và đèn tủ kệ. Chất liệu từ gỗ khắc thủ công, mây tre đan tinh xảo đến vải lụa cao cấp — tất cả được thiết kế để tương thích với nội thất premium.',
      'Dịch vụ tư vấn ánh sáng nội thất trọn gói: KAHA phối hợp với kiến trúc sư và nhà thiết kế nội thất để lựa chọn giải pháp đèn phù hợp cho từng không gian cụ thể. Đã tư vấn và cung cấp đèn cho nhiều dự án biệt thự cao cấp tại TP.HCM, Hà Nội và Đà Nẵng.',
    ],
    relatedPosts: [
      { label: 'Đèn trang trí nội thất chung cư hiện đại', href: '/blog/bo-tri-den-trang-tri-noi-that-chung-cu-hien-dai' },
    ...
    faq: [
      { q: 'Đèn nội thất KAHA phù hợp với phong cách nào?', a: 'Đèn KAHA phù hợp đặc biệt với: Indochine (đèn lồng Hội An, gỗ chạm), Japandi (đèn kiểu Nhật tối giản), Wabi-sabi (đèn mây tre tự nhiên), và Tropical Luxury (đèn lồng vải màu sắc kết hợp cây xanh). Cũng phù hợp nội thất hiện đại khi chọn tông màu trung tính.' },
      { q: 'Làm sao phối đèn trang trí với nội thất sẵn có?', a: 'Nguyên tắc cơ bản: chọn đèn cùng tone màu chủ đạo của phòng (trung tính, ấm, lạnh). Nếu nội thất đã có nhiều chi tiết, chọn đèn đơn giản làm nền. Nếu nội thất tối giản, có thể chọn đèn có hoa văn nổi bật làm điểm nhấn. KAHA tư vấn miễn phí khi gửi ảnh.' },
      { q: 'Đèn thủ công có thể dùng cho biệt thự cao cấp không?', a: 'Hoàn toàn có thể. Nhiều biệt thự và căn hộ penthouse cao cấp tại Việt Nam hiện đang dùng đèn thủ công như điểm nhấn nghệ thuật độc bản. Đèn gỗ chạm khắc hoặc đèn vải cao cấp tùy chỉnh theo màu Pantone là lựa chọn phổ biến. KAHA đã thực hiện nhiều dự án biệt thự 5–15 tỷ.' },
      { q: 'Giá đèn nội thất cao cấp tại KAHA?', a: 'Đèn nội thất trung cấp (ø25–40cm): 150.000đ – 350.000đ. Đèn cao cấp (vải lụa, gỗ chạm): 300.000đ – 680.000đ. Đèn nghệ thuật tùy chỉnh độc bản: từ 800.000đ trở lên tùy thiết kế. Liên hệ 0989.778.247 để nhận tư vấn và báo giá dự án.' },
      { q: 'Có dịch vụ lắp đặt đèn nội thất tận nơi không?', a: 'Có, KAHA cung cấp dịch vụ lắp đặt đèn nội thất tại TP.HCM cho dự án từ 10 chiếc trở lên. Bao gồm khảo sát thực địa, tư vấn bố cục ánh sáng, cung cấp đèn và lắp đặt. Phí lắp đặt tính theo số lượng và độ phức tạp. Liên hệ để được báo giá.' },
    ],
  },
  ...
  'qua-tang': {
    intro: [
      ...
      'KAHA cung cấp dịch vụ đóng gói quà tặng chuyên nghiệp: hộp quà cao cấp, giấy gói thủ công, thiệp chúc viết tay và dây ruy băng trang trí. Phù hợp cho: quà tặng đối tác nước ngoài, quà tặng sự kiện doanh nghiệp (hội nghị, khai trương, year-end party), quà cưới độc đáo và quà lưu niệm phố cổ Hội An.',
      'Đặt quà tặng đèn lồng theo số lượng lớn: KAHA nhận in logo doanh nghiệp, thêu tên công ty hoặc slogan lên đèn, đóng hộp đồng bộ theo bộ nhận diện thương hiệu. Giá quà tặng từ 85.000đ – 580.000đ/set tùy model và cách đóng gói. Liên hệ 0989.778.247 để nhận báo giá quà tặng doanh nghiệp.',
    ],
    relatedPosts: [
    ...
    faq: [
      ...
      { q: 'Có thể in logo công ty lên đèn lồng quà tặng không?', a: 'Có, KAHA nhận in/thêu logo từ 50 chiếc trở lên. Phương pháp: in nhiệt trực tiếp (nhanh, giá tốt) hoặc thêu tay (cao cấp, bền đẹp hơn). Thời gian sản xuất thêm 5–7 ngày. Phù hợp cho quà tặng hội nghị, sự kiện doanh nghiệp và chuỗi khách sạn.' },
      { q: 'Đặt đèn lồng quà tặng số lượng lớn có được giảm giá không?', a: 'Có. Từ 50 chiếc giảm 20%, từ 100 chiếc giảm 25%, từ 200 chiếc giảm 30% so với giá lẻ. Ngoài ra còn có thể đàm phán giá theo dự án cho đơn trên 500 chiếc. KAHA cũng hỗ trợ chi phí đóng gói hộp quà cho đơn từ 100 chiếc.' },
      { q: 'Dịch vụ đóng gói quà tặng của KAHA như thế nào?', a: 'KAHA cung cấp 3 tùy chọn đóng gói: (1) Hộp giấy kraft đơn giản + giấy mỏng + thiệp in sẵn logo — phù hợp quà tặng tập thể. (2) Hộp cứng cao cấp + dây ruy băng + thiệp viết tay — phù hợp quà VIP. (3) Túi vải có logo thêu — phù hợp quà lưu niệm. Phí đóng gói từ 15.000đ – 45.000đ/set.' },
      { q: 'Đèn lồng quà tặng có giao hàng toàn quốc không?', a: 'Có, KAHA giao hàng toàn quốc qua GHN, GHTK và J&T Express. Đơn quà tặng được đóng gói chắc chắn 2 lớp bảo vệ đảm bảo đèn không biến dạng khi vận chuyển. Thời gian giao hàng: 1–2 ngày TP.HCM, 2–4 ngày các tỉnh.' },
    ],
  },
  ...
  'den-san': {
    intro: [
      ...
      'KAHA cung cấp đèn sàn thủ công với 3 phong cách chính: đèn sàn vải lụa phong cách Hội An (khung sắt rèn, chao vải lụa tơ tằm đường kính 35–50cm), đèn sàn kiểu Nhật (khung tre, chao giấy washi hoặc vải mỏng, cao 150–180cm), và đèn sàn tre mây rustic (đan thủ công, ánh sáng xuyên qua khe đan tạo hoa văn trên tường). Phù hợp đặt góc phòng khách, cạnh sofa đọc sách, bên cạnh giường ngủ hoặc tạo điểm nhấn cho quán cafe.',
      'Giá đèn sàn thủ công KAHA từ 220.000đ – 680.000đ/chiếc tùy kiểu dáng và chất liệu. Nhận đặt màu theo yêu cầu, gia công in logo cho chuỗi khách sạn. Giao toàn quốc trong 2–4 ngày, lắp đặt miễn phí tại TP.HCM cho đơn từ 5 chiếc. Liên hệ 0989.778.247 để được tư vấn và xem mẫu thực tế.',
    ],
    relatedPosts: [
      { label: 'Cách chọn đèn trang trí đúng cho nội thất', href: '/blog/cach-chon-den-dung-trang-tri-noi-that' },
    ...
    faq: [
      { q: 'Đèn sàn thủ công KAHA cao bao nhiêu?', a: 'Đèn sàn KAHA có chiều cao từ 140cm đến 185cm tùy model. Phổ biến nhất là 155–165cm — vừa đủ để chao đèn ngang tầm mắt khi ngồi, ánh sáng khuếch tán tự nhiên. Có thể đặt gia công theo chiều cao yêu cầu cho dự án khách sạn.' },
      { q: 'Đặt đèn sàn ở vị trí nào trong phòng khách?', a: 'Vị trí tốt nhất: góc phòng sau sofa (tạo ánh sáng nền ấm), bên cạnh kệ sách (đèn đọc và trang trí), hoặc hai bên TV tạo hiệu ứng backlight. Tránh đặt giữa phòng vì cản lối đi. KAHA tư vấn bố cục ánh sáng miễn phí khi gửi ảnh mặt bằng qua Zalo.' },
      { q: 'Đèn sàn vải lụa có bền không, có dễ bám bụi không?', a: 'Vải lụa tơ tằm của KAHA được xử lý chống bụi tĩnh điện. Bụi bám chỉ cần phủi nhẹ bằng cọ lông mềm 1–2 lần/tháng. Không giặt bằng nước. Tránh đặt gần cửa sổ có nắng trực tiếp để vải giữ màu lâu. Bảo hành 12 tháng cho chao đèn vải.' },
      { q: 'Giá đèn sàn thủ công tại KAHA bao nhiêu?', a: 'Đèn sàn vải lụa Hội An: 220.000đ – 420.000đ. Đèn sàn kiểu Nhật: 280.000đ – 520.000đ. Đèn sàn tre mây cao cấp: 350.000đ – 680.000đ. Đặt sỉ từ 5 chiếc trở lên giảm 15%. Liên hệ 0989.778.247 để nhận báo giá theo yêu cầu cụ thể.' },
      { q: 'Có thể dùng đèn sàn ngoài trời ban công không?', a: 'Đèn sàn vải lụa không phù hợp ngoài trời do dễ bị mưa nắng làm hỏng. Để trang trí ban công, nên chọn dòng đèn tre xử lý chống ẩm hoặc đèn lồng nhựa chịu thời tiết của KAHA. Tư vấn miễn phí khi gọi 0989.778.247.' },
    ],
  },
  ...
  'den-ap-tuong': {
    intro: [
      ...
      'KAHA có 3 dòng đèn áp tường chủ đạo: đèn áp tường lồng Hội An (khung sắt, vải lụa màu sắc phong phú — hợp với nhà hàng, resort có phong cách Indochine), đèn áp tường kiểu Nhật (khung tre, giấy shoji hoặc vải mỏng — tối giản, spa và nhà hàng Nhật), và đèn áp tường mây tre (đan thủ công, ánh sáng tạo hoa văn đổ bóng đẹp trên tường). Có thể gắn đơn lẻ hoặc thành dãy theo hành lang.',
      'Giá đèn áp tường KAHA từ 180.000đ – 520.000đ/chiếc. Nhận gia công theo bản vẽ cho dự án khách sạn, chuỗi nhà hàng. Bao gồm phụ kiện gắn tường, hướng dẫn lắp đặt. Lắp đặt miễn phí tại TP.HCM cho đơn từ 10 chiếc. Liên hệ 0989.778.247.',
    ],
    relatedPosts: [
    ...
    faq: [
      { q: 'Đèn áp tường thủ công lắp đặt thế nào?', a: 'Đèn áp tường KAHA đi kèm bracket gắn tường và vít tiêu chuẩn. Lắp đặt đơn giản trong 15–20 phút: khoan 2 lỗ theo khoảng cách bracket, bắt vít, treo đèn. Dây điện dẫn vào tường qua lỗ khoan sẵn hoặc chạy dọc tường. Có hướng dẫn chi tiết kèm theo sản phẩm.' },
      { q: 'Nên treo đèn áp tường ở độ cao bao nhiêu?', a: 'Đèn áp tường hành lang: treo ở độ cao 2,0–2,2m để chiếu sáng lối đi mà không chói mắt. Đèn áp tường đầu giường: 1,4–1,6m từ sàn (ngang đầu khi ngồi). Đèn hai bên gương phòng tắm: 1,8m từ sàn. KAHA tư vấn vị trí cụ thể theo mặt bằng khi gửi ảnh qua Zalo.' },
      { q: 'Đèn áp tường có phù hợp cho khách sạn không?', a: 'Rất phù hợp. KAHA đã cung cấp đèn áp tường cho hàng trăm khách sạn 3–5 sao, homestay và resort tại VN. Ưu điểm cho khách sạn: tiết kiệm diện tích, dễ vệ sinh, bền đẹp. Nhận gia công đồng bộ màu sắc và kích thước theo tiêu chuẩn từng phòng. Tối thiểu 20 chiếc/đơn gia công.' },
      { q: 'Giá đèn áp tường thủ công tại KAHA?', a: 'Đèn áp tường lồng vải nhỏ ø15–20cm: 180.000đ – 280.000đ. Đèn áp tường kiểu Nhật: 220.000đ – 380.000đ. Đèn áp tường mây tre cao cấp: 280.000đ – 520.000đ. Sỉ từ 10 chiếc giảm 15%, từ 50 chiếc giảm 25%. Liên hệ 0989.778.247 để báo giá dự án.' },
      { q: 'Đèn áp tường phù hợp phong cách nội thất nào?', a: 'Đèn áp tường KAHA phù hợp nhất với: Indochine (đèn lồng Hội An màu sắc ấm), Japandi (đèn kiểu Nhật tối giản), Wabi-sabi (đèn mây tre tự nhiên), và Tropical (kết hợp với cây xanh trong nhà). Không phù hợp với nội thất hiện đại minimalist thuần — cần thêm điểm nhấn khác để cân bằng.' },
    ],
  },
  ...
  'phong-bep': {
    intro: [
      ...
      'KAHA gợi ý 2 vị trí đặt đèn lồng cho phòng ăn và bếp: đèn thả trần phía trên bàn ăn (1 chiếc lớn ø40–60cm hoặc 3 chiếc nhỏ thả ở độ cao khác nhau — tạo hiệu ứng depth đẹp) và đèn áp tường hoặc đèn sàn ở góc phòng ăn tạo ánh sáng nền ấm. Chất liệu phù hợp nhất cho bếp: đèn mây tre (chịu nhiệt tốt, dễ vệ sinh) và đèn vải xử lý chống bụi.',
      'Kinh nghiệm từ thực tế: nhiều quán cafe và nhà hàng TP.HCM đã dùng đèn lồng Hội An thả trần trên bàn ăn thay đèn thả trần kim loại thông thường — tạo ra bầu không khí ấm áp và riêng biệt hơn hẳn. KAHA có sẵn 200+ mẫu đèn thả trần phù hợp phòng ăn, giá từ 85.000đ – 380.000đ/chiếc. Liên hệ 0989.778.247 để được tư vấn chọn theo kích thước bàn ăn.',
    ],
    relatedPosts: [
    ...
    faq: [
      ...
      { q: 'Đèn lồng phòng bếp có an toàn không?', a: 'An toàn khi dùng bóng LED (ít phát nhiệt, không nguy cơ cháy vải). KAHA khuyến nghị bóng LED E27 5W–7W, nhiệt độ màu 2700K–3000K (ánh vàng ấm) cho phòng ăn. Tránh đặt đèn vải quá gần bếp gas — dầu mỡ bắn có thể thấm vào vải. Đèn mây tre phù hợp khu vực gần bếp hơn đèn vải.' },
      ...
      { q: 'Giá đèn trang trí phòng bếp và phòng ăn tại KAHA?', a: 'Đèn thả trần nhỏ ø20–30cm: 85.000đ – 180.000đ. Đèn thả trần phòng ăn ø35–50cm: 150.000đ – 380.000đ. Đèn áp tường khu vực ăn uống: 180.000đ – 320.000đ. Combo 3 đèn thả trần bàn ăn: từ 320.000đ. Giao toàn quốc, lắp đặt miễn phí tại TP.HCM cho đơn từ 5 chiếc.' },
    ],
  },

  'ngoi-sao-nhua': {
    intro: [
      'Đèn ngôi sao nhựa — dòng đèn lồng lắp ráp nhựa đa màu sắc, giá bình dân, phù hợp trang trí lễ hội quy mô lớn, quán ăn bình dân và các sự kiện cộng đồng. Đèn ngôi sao nhựa KAHA có khả năng lắp ráp dễ dàng trong vài phút, không cần dụng cụ, và có thể tháo rời để cất gọn sau lễ hội.',
      'Bộ sưu tập đèn ngôi sao nhựa tại KAHA: đèn ngôi sao 5 cánh và 8 cánh với đường kính 20cm, 25cm, 30cm, 40cm và 60cm. Có 3 dòng chính: đèn nhựa 2 mảnh lắp ráp (phổ biến nhất), đèn nhựa xuyên sáng trong suốt và đèn nhựa có nhạc pin (phù hợp trẻ em). Màu sắc: đỏ, vàng, xanh lá, xanh dương, tím, hồng và trắng.',
      'Giá đèn ngôi sao nhựa tại KAHA: từ 12.000đ – 85.000đ/chiếc tùy kích thước và loại. Sỉ từ 100 chiếc giảm 20%, từ 500 chiếc giảm 30%. Phù hợp cho trường học tổ chức Trung Thu, xã phường trang trí phố phường, siêu thị và trung tâm thương mại treo trang trí mùa lễ hội.',
    ],
    relatedPosts: [
    ...
    faq: [
      { q: 'Đèn ngôi sao nhựa lắp ráp có khó không?', a: 'Rất dễ lắp ráp — chỉ cần 2–5 phút, không cần dụng cụ. Mỗi bộ gồm 2 mảnh nhựa có khớp nối sẵn, chỉ cần ấn vào nhau và gắn dây thả là xong. Phù hợp cả trẻ em từ 6 tuổi trở lên tự lắp. KAHA có video hướng dẫn trên fanpage.' },
      ...
      { q: 'Có bao nhiêu màu sắc đèn ngôi sao nhựa?', a: 'KAHA có 7 màu cơ bản: đỏ, vàng, xanh lá, xanh dương, tím, hồng và trắng. Có thể đặt theo màu cụ thể hoặc combo nhiều màu pha trộn. Mẫu đèn nhựa xuyên sáng trong suốt cũng rất được ưa chuộng vì tạo hiệu ứng ánh sáng đẹp đêm.' },
  ...
  'den-long-trang-tri': {
    intro: [
      'Đèn lồng trang trí — bộ sưu tập tổng hợp hơn 500 mẫu đèn lồng thủ công đẹp nhất từ KAHA, phù hợp mọi không gian và dịp lễ. Từ đèn lồng Hội An truyền thống đến đèn tre mây hiện đại, từ đèn vải cao cấp đến đèn gỗ chạm khắc — tất cả đều được sản xuất thủ công tại Việt Nam bởi nghệ nhân làng nghề.',
      'Đèn lồng trang trí KAHA phục vụ đa dạng nhu cầu: trang trí nhà ở và căn hộ, trang trí quán cafe và nhà hàng, trang trí khách sạn và resort, trang trí sự kiện cưới hỏi, hội nghị và lễ hội, và quà tặng doanh nghiệp. Mỗi dịp, mỗi không gian đều có dòng đèn phù hợp — từ đơn giản bình dân đến phức tạp cao cấp.',
      'Giá đèn lồng trang trí tại KAHA: từ 35.000đ (đèn nhỏ đơn giản) đến 800.000đ (đèn nghệ thuật cao cấp). Phổ biến nhất là tầm 85.000đ – 250.000đ/chiếc. Nhận tư vấn miễn phí, giao hàng toàn quốc, bảo hành 12 tháng. Liên hệ 0989.778.247 để được hỗ trợ lựa chọn.',
    ],
    relatedPosts: [
      ...
      { label: 'Top đèn lồng trang trí bán chạy tại KAHA', href: '/blog/den-long-dep' },
    ],
    faq: [
      { q: 'KAHA có bao nhiêu mẫu đèn lồng trang trí?', a: 'KAHA hiện có hơn 500 mẫu đèn lồng trang trí thuộc 8 dòng chính: đèn lồng Hội An vải lụa, đèn mây tre đan, đèn kiểu Nhật, đèn lồng gỗ, đèn vải cao cấp, đèn thả trần, đèn Trung Thu và đèn Tết. Mẫu mới được cập nhật hàng quý.' },
      { q: 'Làm sao chọn đèn lồng phù hợp cho không gian của mình?', a: 'Cách đơn giản nhất: gửi ảnh không gian và mô tả phong cách muốn hướng đến qua Zalo 0989.778.247. KAHA có đội tư vấn sẵn sàng gợi ý model cụ thể, màu sắc và cách bố trí miễn phí cho đơn từ 5 chiếc trở lên.' },
      { q: 'Đèn lồng trang trí KAHA có xuất xứ ở đâu?', a: '100% sản xuất tại Việt Nam — chủ yếu tại làng nghề Hội An (Quảng Nam) và xưởng sản xuất TP.HCM. Không nhập hàng từ Trung Quốc. Tất cả nghệ nhân là người Việt, kỹ thuật làm đèn truyền thống Việt Nam được giữ gìn và phát triển.' },
      { q: 'Có thể xem hàng thực tế trước khi đặt không?', a: 'Có thể đặt hàng mẫu thử 1 chiếc trước khi đặt sỉ. Ngoài ra, KAHA có showroom trưng bày tại TP.HCM — liên hệ 0989.778.247 để đặt lịch xem hàng và được tư vấn trực tiếp. Cũng có thể xem video review sản phẩm thực tế trên fanpage KAHA.' },
  ...
  'gia-cong-den-trang-tri': {
    intro: [
      'Dịch vụ gia công đèn trang trí theo yêu cầu — KAHA nhận thiết kế và sản xuất đèn lồng tùy chỉnh cho doanh nghiệp, khách sạn, resort, nhà hàng và sự kiện. Từ màu sắc, kích thước, hoa văn đến in/thêu logo thương hiệu — tất cả đều có thể tùy chỉnh theo bản vẽ của khách hàng.',
      'Quy trình gia công: (1) Khách hàng cung cấp yêu cầu và mẫu tham khảo → (2) KAHA thiết kế bản vẽ kỹ thuật miễn phí → (3) Sản xuất mẫu thử trong 3–5 ngày → (4) Xác nhận mẫu → (5) Sản xuất đại trà. Thời gian sản xuất từ 7–21 ngày tùy số lượng và độ phức tạp. Số lượng tối thiểu: 20 chiếc/mẫu.',
      'Dịch vụ gia công đèn KAHA phù hợp cho: quà tặng doanh nghiệp in logo, trang trí sự kiện quy mô lớn (wedding, gala, hội nghị), chuỗi khách sạn cần đèn đồng bộ thương hiệu và xuất khẩu. Giá gia công cạnh tranh, giảm thêm theo số lượng. Liên hệ 0989.778.247 để nhận báo giá trong 24 giờ.',
    ],
    relatedPosts: [
    ...
    faq: [
      ...
      { q: 'Có thể in logo lên đèn không?', a: 'Có. KAHA nhận in logo bằng nhiều phương pháp: in nhiệt trực tiếp lên vải, thêu tay hoặc thêu máy, và dán decal chịu nhiệt. In nhiệt phù hợp số lượng lớn, thêu tay cho sản phẩm cao cấp.' },
      ...
      { q: 'Có thể thiết kế hoàn toàn mới theo ý tưởng của tôi không?', a: 'Hoàn toàn có thể. KAHA có đội ngũ thiết kế sản xuất bản vẽ kỹ thuật miễn phí dựa trên ý tưởng của khách hàng. Bạn chỉ cần mô tả ý tưởng, cung cấp hình ảnh tham khảo hoặc brand guideline — chúng tôi sẽ dịch thành sản phẩm thực tế.' },
      { q: 'Có thể gia công đèn xuất khẩu ra nước ngoài không?', a: 'Có. KAHA có kinh nghiệm gia công đèn lồng xuất khẩu sang Nhật Bản, Hàn Quốc, Mỹ và châu Âu. Sản phẩm được đóng gói theo tiêu chuẩn xuất khẩu, kèm CO/CQ nếu cần. Liên hệ để được tư vấn về yêu cầu kỹ thuật và chứng từ xuất khẩu.' },
      { q: 'Chất liệu nào có thể dùng để gia công đèn trang trí?', a: 'KAHA gia công đèn với nhiều chất liệu: vải lụa, organza, cotton, đay, mây tre đan, gỗ tự nhiên và khung sắt sơn tĩnh điện. Mỗi chất liệu phù hợp với phong cách và không gian khác nhau. Tư vấn viên sẽ đề xuất chất liệu tối ưu dựa trên mục đích sử dụng và ngân sách của bạn.' },
      { q: 'Có thể xem mẫu thực tế trước khi đặt số lượng lớn không?', a: 'Có. KAHA luôn sản xuất mẫu thử (sample) trước khi sản xuất đại trà. Chi phí mẫu thử được tính theo giá vật liệu thực tế, sẽ được hoàn lại khi đặt đơn sản xuất đại trà từ 50 chiếc trở lên. Mẫu thử hoàn thành trong 3–5 ngày làm việc.' },
      { q: 'KAHA có hỗ trợ lắp đặt tận nơi không?', a: 'Có, KAHA hỗ trợ lắp đặt tận nơi cho đơn hàng tại TP.HCM và các tỉnh lân cận (Bình Dương, Đồng Nai, Long An). Với các tỉnh xa hơn, đội kỹ thuật có thể di chuyển theo thỏa thuận. Chi phí lắp đặt tính theo quy mô công trình và khoảng cách.' },
...
const CATEGORY_META: Record<string, { title: string; description: string }> = {
  ...
  'den-long-tet': {
    title: 'Đèn Lồng Tết 2026 | Bán Sỉ Lẻ | Xưởng KAHA TP.HCM',
  ...
  'den-may-tre': {
    title: 'Đèn Mây Tre Thủ Công Việt Nam | Bán Sỉ Toàn Quốc | KAHA',
  ...
  'den-kieu-nhat': {
    title: 'Đèn Lồng Kiểu Nhật Bản | Thủ Công Cao Cấp | KAHA',
  ...
  'den-vai-cao-cap': {
    title: 'Đèn Vải Cao Cấp Thủ Công | In Logo | Giá Sỉ | KAHA',
  ...
  'den-san': {
    title: 'Đèn Sàn Thủ Công Trang Trí | Đèn Đứng Nội Thất | KAHA',
  ...
  'den-ap-tuong': {
    title: 'Đèn Áp Tường Thủ Công | Đèn Treo Tường Trang Trí | KAHA',
  ...
  'phong-bep': {
    title: 'Đèn Trang Trí Phòng Bếp & Phòng Ăn | Thủ Công | KAHA',
  ...
  'den-long-go': {
    title: 'Đèn Lồng Gỗ Chạm Khắc | Quà Tặng Cao Cấp | KAHA',
  ...
  'den-ve-tranh': {
    title: 'Đèn Vẽ Tranh Thủ Công | Đèn Lồng Nghệ Thuật | KAHA',
  ...
  'phong-khach': {
    title: 'Đèn Trang Trí Phòng Khách Thủ Công | KAHA',
  ...
  'phong-ngu': {
    title: 'Đèn Trang Trí Phòng Ngủ | Ánh Sáng Dịu Nhẹ | KAHA',
  ...
  'den-quan-cafe': {
    title: 'Đèn Trang Trí Quán Cafe | 200+ Mẫu | Giá Sỉ | KAHA',
  ...
  'den-nha-hang': {
    title: 'Đèn Trang Trí Nhà Hàng | Gia Công Số Lượng Lớn | KAHA',
  ...
  'den-khach-san': {
    title: 'Đèn Trang Trí Khách Sạn Resort | Gia Công | KAHA',
  ...
  'ngoai-troi': {
    title: 'Đèn Trang Trí Ngoài Trời | Ban Công Sân Vườn | KAHA',
  ...
  'den-noi-that': {
    title: 'Đèn Trang Trí Nội Thất Cao Cấp | Thủ Công | KAHA',
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = custom?.title ?? `${label} — Đèn Thủ Công Việt Nam | KAHA`;
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{
        ...
        width: 1200,
        height: 800,
        alt: `${label} — Đèn Lồng Thủ Công KAHA`,
      }],
    },
  };
}
...
export default async function CategoryPage({ params }: Props) {
  ...
  const jsonLd = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'Sản phẩm',
        item: 'https://kaha.vn/san-pham',
      },
      {
        '@type': 'ListItem',
        position: 3,
        name: cat?.label ?? slug,
        item: `https://kaha.vn/c/${slug}`,
      },
    ],
  };
  ...
  const collectionPageLd = {
    '@context': 'https://schema.org',
    '@type': 'CollectionPage',
    '@id': `https://kaha.vn/c/${slug}`,
    name: `${cat?.label ?? slugToLabel(slug)} — Đèn Thủ Công Việt Nam | KAHA`,
    ...
    url: `https://kaha.vn/c/${slug}`,
    numberOfItems: catProducts.length,
    isPartOf: { '@type': 'WebSite', '@id': 'https://kaha.vn' },
    ...(normalizedSlug === 'den-trung-thu' ? {
      offers: {
        ...
        highPrice: 250000,
        offerCount: 300,
        seller: { '@type': 'Organization', name: 'KAHA' },
      },
    } : {}),
  };
  ...
  const FAQ_DATA: Record<string, { q: string; a: string }[]> = {
    'den-trung-thu': [
      { q: 'Lồng đèn trung thu thủ công KAHA có những mẫu nào?', a: 'KAHA có 300+ mẫu lồng đèn Trung Thu thủ công gồm: đèn ông sao, đèn cá chép, đèn bướm, đèn kéo quân, đèn con thỏ, đèn hoa sen và đèn lồng Hội An truyền thống. Tất cả làm tay bằng chất liệu an toàn cho trẻ em.' },
      ...
      { q: 'KAHA có giao lồng đèn trung thu toàn quốc không?', a: 'Có. KAHA giao hàng toàn quốc qua các đối tác vận chuyển. Nội thành TP.HCM giao trong ngày (trước 10h sáng). Tỉnh thành khác 2–5 ngày làm việc.' },
      { q: 'Mua sỉ lồng đèn trung thu số lượng lớn ở đâu?', a: 'KAHA nhận đơn sỉ lồng đèn Trung Thu từ 50 chiếc trở lên. Hỗ trợ in logo thương hiệu, đóng gói theo yêu cầu. Gọi ngay 0989.778.247 hoặc nhắn Zalo để được báo giá.' },
      { q: 'Lồng đèn trung thu KAHA có an toàn cho trẻ em không?', a: 'Tất cả lồng đèn Trung Thu của KAHA dùng chất liệu an toàn: tre mây tự nhiên, vải không độc hại, sơn nước thân thiện môi trường. Phù hợp trẻ em từ 3 tuổi trở lên khi có người lớn giám sát.' },
    ],
    'hoi-an-lantern': [
      { q: 'Đèn lồng Hội An KAHA được làm từ chất liệu gì?', a: 'Đèn lồng Hội An tại KAHA được làm từ khung tre/sắt thủ công kết hợp vải lụa, vải bố hoặc vải tơ tằm. Mỗi chiếc đèn do nghệ nhân làng nghề Hội An làm tay, đảm bảo đúng kỹ thuật truyền thống.' },
      { q: 'Mua đèn lồng Hội An ở đâu uy tín tại TP.HCM?', a: 'KAHA là xưởng sản xuất đèn lồng Hội An lớn tại TP.HCM với 500+ mẫu. Địa chỉ: 262/1/93 Phan Anh, P.Phú Thạnh, Q.Tân Phú. Hotline 0989.778.247 — giao hàng miễn phí nội thành từ 500k.' },
      { q: 'Đèn lồng Hội An có bao nhiêu màu sắc?', a: 'KAHA có hơn 20 màu sắc đèn lồng Hội An: đỏ, vàng, xanh lá, tím, hồng, cam, trắng ngà, xanh dương và các màu phối. Có thể đặt màu theo yêu cầu cho đơn sỉ từ 20 chiếc.' },
      { q: 'Đèn lồng Hội An dùng trong nhà hàng, quán cafe được không?', a: 'Hoàn toàn phù hợp. KAHA cung cấp đèn lồng Hội An cho hàng trăm quán cafe, nhà hàng, resort trên cả nước. Tư vấn miễn phí bố cục, chọn mẫu phù hợp không gian.' },
      { q: 'Đèn lồng Hội An có bền không, bảo quản thế nào?', a: 'Đèn lồng Hội An chất liệu tốt dùng được 2–5 năm nếu bảo quản đúng cách. Tránh để ngoài mưa trực tiếp, lau bằng khăn khô khi bụi. Vải có thể thay thế khi cần — KAHA hỗ trợ thay vải theo yêu cầu.' },
    ],
    'den-long-tet': [
      { q: 'Đèn lồng Tết có những mẫu phổ biến nào?', a: 'Các mẫu đèn lồng Tết phổ biến tại KAHA gồm: đèn lồng đỏ truyền thống, đèn lồng hoa đào, đèn lồng cành mai, đèn cá chép, đèn lồng 12 con giáp và đèn lồng Hội An phong cách Tết. Hơn 200 mẫu để chọn.' },
      { q: 'Mua sỉ đèn lồng Tết giá tốt ở đâu?', a: 'KAHA nhận đơn sỉ đèn lồng Tết từ 100 chiếc trở lên với giá ưu đãi 20–40%. Hỗ trợ in logo, đóng gói quà tặng doanh nghiệp. Hotline 0989.778.247 — đặt hàng sớm trước Tết 30–45 ngày.' },
    ...
    'den-may-tre': [
      { q: 'Đèn mây tre đan KAHA được làm từ nguyên liệu gì?', a: 'Đèn mây tre đan KAHA dùng tre già tự nhiên từ làng nghề miền Trung, mây sợi chọn lọc và sơn/dầu bảo vệ bề mặt thân thiện môi trường. Mỗi chiếc đan thủ công 100% bởi nghệ nhân 20+ năm kinh nghiệm.' },
      ...
      { q: 'Đèn mây tre có bền không, dùng được bao lâu?', a: 'Đèn mây tre chất lượng cao của KAHA bền 3–7 năm nếu để trong nhà tránh ẩm. Có thể dùng ngoài trời mái che. Phun một lớp sơn bảo vệ mỗi năm để kéo dài tuổi thọ.' },
      { q: 'Giá đèn mây tre đan bao nhiêu?', a: 'Giá đèn mây tre tại KAHA từ 150.000đ–1.500.000đ tùy kích thước và độ phức tạp. Giảm giá sỉ từ 10 chiếc. Liên hệ 0989.778.247 để được báo giá chi tiết.' },
    ],
    'den-kieu-nhat': [
      { q: 'Đèn lồng kiểu Nhật Bản KAHA khác gì đèn Hội An?', a: 'Đèn kiểu Nhật (Chochin) có đặc trưng: hình ống, khung tre mềm, giấy washi hoặc vải trắng mỏng, ánh sáng khuếch tán đều. Đèn Hội An có hình cầu/bầu dục, vải màu sắc rực rỡ hơn. Cả hai đều thủ công 100%.' },
      ...
      { q: 'KAHA có bao nhiêu mẫu đèn kiểu Nhật?', a: 'KAHA có 200+ mẫu đèn kiểu Nhật từ cỡ nhỏ (đường kính 15cm) đến cỡ lớn (60cm), bao gồm: đèn Chochin treo, đèn Bonbori để bàn, đèn Andon vuông và đèn lồng Nhật treo cửa.' },
    ],
    'gia-cong-den-trang-tri': [
      { q: 'KAHA nhận gia công đèn trang trí theo yêu cầu không?', a: 'Có. KAHA nhận gia công đèn lồng trang trí hoàn toàn theo yêu cầu: kích thước, màu sắc, chất liệu, hình dạng, in logo thương hiệu. Phù hợp cho khách sạn, resort, sự kiện, quà tặng doanh nghiệp. Đặt hàng tối thiểu 20 chiếc.' },
      ...
      { q: 'KAHA có thiết kế đèn theo bản vẽ không?', a: 'Có. Đội ngũ KAHA sẽ tư vấn, phác thảo thiết kế và làm mẫu thử trước khi sản xuất hàng loạt. Phí thiết kế miễn phí cho đơn từ 50 chiếc trở lên.' },
    ],
  };
  ...
  const itemListSchema = catProducts.length > 0 ? {
    ...
    'itemListElement': catProducts.slice(0, 10).map((p, i) => ({
      '@type': 'ListItem',
      'position': i + 1,
      'url': `https://kaha.vn/p/${p.slug}`,
      'name': p.name,
      'image': p.image.startsWith('/') ? `https://kaha.vn${p.image}` : p.image,
    })),
  } : null;
      ...
      <div className="max-w-7xl mx-auto px-4 pb-12">
        ...
        >
          <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-5 px-7 py-7 md:py-6">
            <div>
              <p className="text-[10.5px] font-bold uppercase tracking-[0.22em] mb-1.5" style={{ color: '#e8a84a' }}>KAHA®</p>
