...
export const SETTINGS_DEFAULTS: SiteSettings = {
  ...
  home_reviews: JSON.stringify([
    ...
    {"stars":5,"text":"Khách sạn boutique của mình cần thay mới toàn bộ đèn trang trí hành lang. Sau khi so sánh vài nơi, chọn KAHA vì catalogue đa dạng và nhân viên tư vấn hiểu rõ về chất liệu. Lắp xong nhìn rất sang, khách hay chụp ảnh check-in ở đây. Đã giới thiệu thêm cho 2 khách sạn bạn bè.","avatar":"","name":"Hải Yến","meta":"Chủ khách sạn boutique · Hội An"},
    ...
    {"stars":5,"text":"Quán mình ở Hội An, cạnh tranh cao lắm vì xung quanh toàn đèn lồng. Nhưng đèn của KAHA màu đẹp hơn hàng địa phương mình hay mua, vải dày và không bị nhạt sau mưa. Khách Tây hay dừng lại chụp ảnh trước quán. Đã mua 3 lần rồi, lần nào cũng ổn.","avatar":"","name":"Quốc Hùng","meta":"Mua lần 3 · Hội An"},
    ...
    {"stars":5,"text":"We run a Vietnamese-themed event space in Singapore and have been sourcing lanterns from various suppliers. KAHA consistently delivers the best quality at competitive wholesale prices. Colors are vibrant and hold up well under event lighting. Will continue ordering for all our events.","avatar":"","name":"Christine Lim","meta":"Event Space Owner · Singapore"},
  ...
  about_timeline: JSON.stringify([
    {"year":"2016","event":"Thành lập KAHA, bắt đầu hợp tác với 3 nghệ nhân đầu tiên tại Hội An"},
  ...
  about_hero_title: 'Câu Chuyện KAHA',
  ...
  home_b2b_full_img_alt: 'Đèn tròn vải lụa trắng treo trần khách sạn — dự án lắp đặt đèn lồng sỉ KAHA TP.HCM',
  ...
  home_use_cases_desc: 'Từ quán cafe đến khách sạn, từ trang trí gia đình đến sự kiện lớn — KAHA có mẫu phù hợp.',
